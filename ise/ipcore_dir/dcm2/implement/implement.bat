...
xst -ifn xst.scr
move dcm2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm2_exdes.ucf dcm2_exdes

echo 'Running map'
map -timing -pr b dcm2_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm2_exdes -w routed.ncd routed.v
cd ..
